...
"""
    swat 28.11.2014
    version 0.0.2.2
    Модуль импорта чеков из mssql SES кристалл
"""
...
class ImportSES():
    ...
    def __init__(self, parent_class):
        ...
        self.sale_rbs = s.BaseImpSale(self.parent_class, 'SES')

        '''
            получим из параметров задания code MSSQL БД
            если коннекта к БД нет выходим
        '''
        self.db_cash_connect = self.parent_class.MSSQLConnect(self.sale_rbs.qt_params['code_db_SES'])
